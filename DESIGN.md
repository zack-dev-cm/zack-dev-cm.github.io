...
description: Open Design-inspired public portfolio system for AI product engineering references, case studies, resume assets, and the hidden Skill Wind cover page.
colors:
  page: "#05070B"
  rail: "#090D12"
  surface: "#10161D"
...
recruiters should see what Zakhar can ship, which references are public, and where to
...
color, green review-gate accents, amber metric accents, and sparse alert red
...
reference column. The first viewport should show identity, hiring routes, the
...
routes into the work, and one compact metrics board. On mobile, at least one
...
plain-language title, one metric or reference line, stack chips, and a visible open affordance.
The profile navigation is grouped by Start, Work, and Explore. The sticky
...
Metric surfaces such as ClawHub and Chrome Web Store stats should use compact
metrics boards, not long marketing cards. Put exact dated counters in a dense
...
- Do keep project metrics conservative and dated when they are snapshots.
