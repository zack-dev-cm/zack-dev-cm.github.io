...
Summary: Senior computer vision engineer shipping OCR, segmentation, detection, multimodal search, VLM/LLM workflows, and full-stack AI products across web, mobile, and cloud.
...
## Key Files
- https://zack-dev-cm.github.io/agent-discovery.json
...
- Where should agents start? Use agent-discovery.json for structured routing, llms.txt for a compact index, llms-full.txt for portfolio memory, geo.txt for retrieval-oriented summaries, and project markdown pages for canonical detail. Citation: https://zack-dev-cm.github.io/agent-discovery.json
