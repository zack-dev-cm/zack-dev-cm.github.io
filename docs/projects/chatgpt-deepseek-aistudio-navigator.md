# ChatGPT/Deepseek/AIStudio Navigator

> Chrome extension with keyboard scrollbar, prompt autocomplete, and sharing.
...
- Public Chrome Web Store users: 64 (Chrome Web Store detail page, 2026-05-15)
