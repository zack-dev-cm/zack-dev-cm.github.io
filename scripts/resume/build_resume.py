...
parts=['<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">',
 '<title>Zakhar Pashkin - Senior ML Engineer Resume</title><meta name="description" content="Senior ML Engineer resume: computer vision, document AI, agentic systems, Carb Manager, CFT, Dermaself and Agnitra.">',
